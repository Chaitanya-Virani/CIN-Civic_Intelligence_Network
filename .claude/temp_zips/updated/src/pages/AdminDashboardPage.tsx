...
const SECTOR_META: Record<Sector, { label: string; icon: typeof GraduationCap }> = {
...
export function AdminDashboardPage() {
  ...
  // sectors present among live tenants, in a stable order
  ...
  // keep the sector toggle honest if the active tenant changes from elsewhere
  useEffect(() => {
  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-10">
      ...
      {/* tenant cards within the selected sector */}
      ...
      {/* live snapshot for the active tenant */}
      <div className="mt-10">
